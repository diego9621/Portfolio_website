const App = () => {
  ...
  return (
    <div>
      ...
      <section id="skills" className="p-4 bg-gray-100">
        <h2 className="text-xl font-semibold mb-2">Skills</h2>
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          {['Python','SQL','ETL Pipelines','Web Scraping','Data Visualization','Fast Data Processing'].map(skill => (
            <div key={skill} className="bg-white rounded shadow p-2 text-center">
              {skill}
            </div>
          ))}
        </div>
      ...
      <section id="contact" className="p-4 bg-gray-100">
        ...
        <p>Email: <a href="mailto:your.email@example.com" className="text-blue-700 underline">your.email@example.com</a></p>
      </section>

      <footer className="bg-blue-700 text-white text-center p-4 mt-4">
